...
///
/// Used by [RenderEditableWithToolbar.onSelectionChanged].
typedef SelectionChangedHandlerX = void Function(TextSelection selection,
...
class RenderEditableWithToolbar extends RenderBox
  ...
  SelectionChangedHandlerX onSelectionChanged;
  ...
  /// with the most recently set [ToolbarTextSelectionDelegate].
  ...
  ///
  /// [RenderEditableWithToolbar] is responsible for calculating the [Offset] of this
  ...
  ///
  /// Since [RenderEditableWithToolbar] does not handle selection manipulation
