...
/// methods such as [RenderEditableWithToolbar.selectPosition],
/// [RenderEditableWithToolbar.selectWord], etc. programmatically.
///
/// See also:
///
///  * [TextField], which is a full-featured, material-design text input field
///    with placeholder text, labels, and [Form] integration.
class EditableTextWithToolbar extends StatefulWidget {
  ...
  ///
  /// The cursor refers to the blinking caret when the [EditableTextWithToolbar] is focused.
  /// {@endtemplate}
  ///
  /// See also:
  ///
  ...
  ///
  /// See [RenderEditableWithToolbar.locale] for more information.
  final Locale locale;
  ...
  ///
  /// The [EditableTextWithToolbar] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [EditableTextWithToolbarState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [EditableTextWithToolbar] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [EditableTextWithToolbar], which
  ...
  /// [EditableTextWithToolbar] internally, and uses the value of `onFieldSubmitted` as its
  /// [onSubmitted]).
  ///
  /// ```dart
  ...
  ///
  /// The [mouseCursor] is the only property of [EditableTextWithToolbar] that controls the
  /// appearance of the mouse pointer. All other properties related to "cursor"
  /// stands for the text cursor, which is usually a blinking vertical line at
  /// the editing position.
  final MouseCursor mouseCursor;

  /// If true, the [RenderEditableWithToolbar] created by this widget will not handle
  /// pointer events, see [RenderEditableWithToolbar] and [RenderEditableWithToolbar.ignorePointer].
  ///
  ...
  ///
  /// If this property is null, [RenderEditableWithToolbar.preferredLineHeight] will be used.
  /// {@endtemplate}
  ...
  /// [RenderEditableWithToolbar.selectionEnabled].
  /// {@endtemplate}
  ...
  /// [EditableTextWithToolbar].
  ///
  /// If a restoration id is provided, the [EditableTextWithToolbar] will persist its
  /// current scroll offset and restore it during state restoration.
  ///
  /// The scroll offset is persisted in a [RestorationBucket] claimed from
  /// the surrounding [RestorationScope] using the provided restoration ID.
  ///
  /// Persisting and restoring the content of the [EditableTextWithToolbar] is the
  ...
  @override
  EditableTextWithToolbarState createState() => EditableTextWithToolbarState();
...
/// State for a [EditableTextWithToolbar].
class EditableTextWithToolbarState extends State<EditableTextWithToolbar>
    with
        AutomaticKeepAliveClientMixin<EditableTextWithToolbar>,
        WidgetsBindingObserver,
        TickerProviderStateMixin<EditableTextWithToolbar>
    implements ToolbarTextSelectionDelegate, TextInputClient, AutofillClient {
  Timer _cursorTimer;
  ...
  TextSelectionWithToolbarOverlay _selectionOverlay;
  ...
  @override
  void didUpdateWidget(EditableTextWithToolbar oldWidget) {
  ...
  void _handleSelectionChanged(TextSelection selection,
      RenderEditableWithToolbar renderObject, SelectionChangedCause cause) {
    ...
    if (widget.selectionControls != null) {
      _selectionOverlay = TextSelectionWithToolbarOverlay(
        context: context,
        value: _value,
  ...
  @visibleForTesting
  TextSelectionWithToolbarOverlay get selectionOverlay => _selectionOverlay;
  ...
  void _startCursorTimer() {
    ...
    if (EditableTextWithToolbar.debugDeterministicCursor) return;
    if (widget.cursorOpacityAnimates) {
      _cursorTimer =
  ...
  /// when [RenderEditableWithToolbar.ignorePointer] is true.
  RenderEditableWithToolbar get renderEditable =>
      _editableKey.currentContext.findRenderObject()
          as RenderEditableWithToolbar;
        ...
        viewportBuilder: (BuildContext context, ViewportOffset offset) {
          return CompositedTransformTarget(
            ...
            child: _Editable(
              ...
              showCursor: EditableTextWithToolbar.debugDeterministicCursor
...
class _Editable extends LeafRenderObjectWidget {
  ...
  final SelectionChangedHandlerX onSelectionChanged;
  ...
  final ui.BoxWidthStyle selectionWidthStyle;
  final bool enableInteractiveSelection;
  final ToolbarTextSelectionDelegate textSelectionDelegate;
  ...
  @override
  RenderEditableWithToolbar createRenderObject(BuildContext context) {
    return RenderEditableWithToolbar(
      text: textSpan,
  ...
  void updateRenderObject(
      BuildContext context, RenderEditableWithToolbar renderObject) {
    renderObject
      ..text = textSpan
      ..cursorColor = cursorColor
      ..startHandleLayerLink = startHandleLayerLink
